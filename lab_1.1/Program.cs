...
namespace Lap_1
{
    class BankAccount
    {
        ...
        {
            Console.WriteLine("Id account: {0}", Id);
            Console.WriteLine("balance in the account: {0}", Balance);
    ...
    class Program
    {
        ...
        public bool IsIdExists(int id) // check id da ton tai hay chua
        {
            return accounts.Exists(x => x.Id == id);
        }
        public void AddBankAccount(int id) //funtion add account
        {
            accounts.Add(new BankAccount(id));
        }
        static void Main(string[] args) //lenh thuc hien chinh
        {
            ...
            Console.WriteLine("4. Print information account");
